  ...
  return (
    <div className={`h-screen w-full ${styles.bgImage} `}>
      ...
      <div className={`${styles.bodyContent}  px-6`}>
        <div className={`${styles.squareDiamond}`}>
          <Image
            src={Diamond}
            alt="Diamond"
            className={`${styles.squareDiamondSVG}`}
          />
          <div
            ...
            <div
              className={`${styles.diamondMiddleContent} flex flex-row justify-center`}>
              <ChevronLeftIcon
                className={`${styles.chevronIcon} text-bGreen cursor-pointer`}
                onClick={handlePrev}
              />
              <div
              ...
              <ChevronRightIcon
                className={`${styles.chevronIcon} z-10 text-bGreen cursor-pointer`}
                onClick={handleNext}
              />
            </div>
            <span
              className={`${styles.diamondBottom} text-center flex flex-col items-center justify-around `}>
              <button className={`${styles.learnMoreButton}`}>Know More</button>
